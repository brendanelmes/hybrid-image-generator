...
def create_hybrid_images(image1, image2, sigma1, sigma2):

    # Apply low-pass filter to each image using cutoff values
    lpf_image1 = low_pass_filter(image1, sigma1)
    lpf_image2 = low_pass_filter(image2, sigma2)
...
hybrid1, hybrid2 = create_hybrid_images(photo1, photo2, cutoff1, cutoff2)
